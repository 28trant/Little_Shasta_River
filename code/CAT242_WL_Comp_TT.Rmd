...
uncompensated_data <- read_xle(here("data", "Solinst raw files", "2196341_EVN_2025_06_17_220445.xle")) %>%
  clean_names()
...
compensated_data <- read_xle(here("data", "Solinst compensated files", "2196341_EVN_2025_06_17_220445Compensated.xle"))%>%
  clean_names()
...
sol_baro_data <- read_xle(here("data", "Solinst raw files", "2197653_EVN_BARO_2025_06_17_215946.xle"))%>%
  clean_names()
...
KCAMONTA81 <- read.csv(here("data", "KCAMONTA81.csv")) %>% clean_names() %>% 
