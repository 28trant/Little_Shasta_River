...
# This code uses the functional flow package hosted on github.com/ceff-tech/ffc_api_client to assess the functional flow patterns of the Little Shasta River. 
...
# Everything works! We can now use the calculator to assess functional flows for the Little Shasta River.
