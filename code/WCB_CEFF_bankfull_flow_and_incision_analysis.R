...
#BF_L_height_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1110, 7] <- 2910.024-min(BF_xsxn_1110$elevation_ft)

#BF_L_width_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1110, 8] <- 39.7764-38.4048

#BF_R_height_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1110, 9] <- 2909.835-min(BF_xsxn_1110$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1239, 7] <- 2877.122-min(BF_xsxn_1239$elevation_ft)

#BF_L_width_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1239, 8] <- 30.6324-xsxn_1239_BF_L

#BF_R_height_ft
xsxn_LOI3[xsxn_LOI3$xsxn_id==1239, 9] <- 2877.101-min(BF_xsxn_1239$elevation_ft)
...
#BF_L_length
xsxn_LOI3$xsxn_BF_L_length_ft <- sqrt((xsxn_LOI3$BF_L_h_ft)^2+(xsxn_LOI3$BF_L_w_m*1/0.3048)^2)

#BF_R_length
xsxn_LOI3$xsxn_BF_R_length_ft <- sqrt((xsxn_LOI3$BF_R_h_ft)^2+(xsxn_LOI3$BF_R_w_m*1/0.3048)^2)

# Wetted perimeter
xsxn_LOI3$R_hyd_rad <- xsxn_LOI3$xsxn_BF_L_length_ft+xsxn_LOI3$xsxn_BF_R_length_ft+xsxn_LOI3$xsxn_BF_base_length_ft
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==1942, 7] <- 2715.950-min(BF_xsxn_1942$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==1942, 8] <- 45.7200-xsxn_1942_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==1942, 9] <- 2716.860-min(BF_xsxn_1942$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2085, 7] <- 2712.632-min(BF_xsxn_2085$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2085, 8] <- 31.0896-xsxn_2085_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2085, 9] <- 2712.447-min(BF_xsxn_2085$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2103, 7] <- 2702.837-min(BF_xsxn_2103$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2103, 8] <- 21.4884-xsxn_2103_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2103, 9] <- 2702.874-min(BF_xsxn_2103$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2119, 7] <- 2693.511-min(BF_xsxn_2119$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2119, 8] <- 26.9748-xsxn_2119_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2119, 9] <- 2693.543-min(BF_xsxn_2119$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2200, 7] <- 2686.318-min(BF_xsxn_2200$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2200, 8] <- 20.5740-xsxn_2200_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2200, 9] <- 2686.055-min(BF_xsxn_2200$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2217, 7] <- 2675.719-min(BF_xsxn_2217$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2217, 8] <- 30.6324-xsxn_2217_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2217, 9] <- 2675.745-min(BF_xsxn_2217$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2231, 7] <- 2667.230-min(BF_xsxn_2231$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2231, 8] <- 31.0896-xsxn_2231_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2231, 9] <- 2667.252-min(BF_xsxn_2231$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2244, 7] <- 2656.006-min(BF_xsxn_2244$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2244, 8] <- 33.8328-xsxn_2244_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2244, 9] <- 2656.040-min(BF_xsxn_2244$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2305, 7] <- 2647.118-min(BF_xsxn_2305$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2305, 8] <- 29.7180-xsxn_2305_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2305, 9] <- 2647.176-min(BF_xsxn_2305$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2327, 7] <- 2642.217-min(BF_xsxn_2327$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2327, 8] <- 35.6616-xsxn_2327_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2327, 9] <- 2642.349-min(BF_xsxn_2327$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2396, 7] <- 2636.015-min(BF_xsxn_2396$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2396, 8] <- 28.8036-xsxn_2396_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2396, 9] <- 2635.722-min(BF_xsxn_2396$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2412, 7] <- 2623.467-min(BF_xsxn_2412$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2412, 8] <- 27.4320-xsxn_2412_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2412, 9] <- 2623.485-min(BF_xsxn_2412$elevation_ft)
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2499, 7] <- 2608.661-min(BF_xsxn_2499$elevation_ft)

#BF_L_width_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2499, 8] <- 32.9184-xsxn_2499_BF_L

#BF_R_height_ft
xsxn_LOI2[xsxn_LOI2$xsxn_id==2499, 9] <- 2608.684-min(BF_xsxn_2499$elevation_ft)
...
# Wetted perimeter
xsxn_LOI2$R_hyd_rad <- xsxn_LOI2$xsxn_BF_L_length_ft+xsxn_LOI2$xsxn_BF_R_length_ft+xsxn_LOI2$xsxn_BF_base_length_ft
...
#Define other geometry data
#BF_L_height_ft
xsxn_LOI1[xsxn_LOI1$xsxn_id==3800, 7] <- xsxn_3800_BF_L_elev-min(BF_xsxn_3800$elevation_ft)

#BF_L_width_ft
xsxn_LOI1[xsxn_LOI1$xsxn_id==3800, 8] <- xsxn_3800_base_L-xsxn_3800_BF_L

#BF_R_height_ft
xsxn_LOI1[xsxn_LOI1$xsxn_id==3800, 9] <- xsxn_3800_BF_R_elev-min(BF_xsxn_3800$elevation_ft)
...
# Wetted perimeter
xsxn_LOI1$R_hyd_rad <- xsxn_LOI1$xsxn_BF_L_length_ft+xsxn_LOI1$xsxn_BF_R_length_ft+xsxn_LOI1$xsxn_BF_base_length_ft
